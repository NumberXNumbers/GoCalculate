...
func TrapezoidRule(a float32, b float32, N int, f func(float32) float32) float32 {
	var omega float32
	h := (b - a) / float32(N)
	x := a
...
func SimpsonRule(a float32, b float32, N int, f func(float32) float32) float32 {
	var omega float32
	h := (b - a) / float32(N)
	x := a
...
func Simpson38Rule(a float32, b float32, N int, f func(float32) float32) float32 {
	var omega float32
	h := (b - a) / float32(N)
	x := a
...
func BooleRule(a float32, b float32, N int, f func(float32) float32) float32 {
	var omega float32
	h := (b - a) / float32(N)
	x := a
...
func AdamsBashforth2(a float32, b float32, N int, initialCondition1 float32,
	...
	omega := omega2
	scalingConstantFactor := stepSize / 2

	var kappa float32
	var kappa2 float32

	for i := 2; i < N; i++ {
		kappa = scalingConstantFactor * 3 * f(solutionSet[i][0], solutionSet[i][1])
...
func AdamsBashforth3(a float32, b float32, N int, initialCondition1 float32,
	...
	omega := omega3
	scalingConstantFactor := stepSize / 12
	...
	for i := 2; i < N; i++ {
		kappa = scalingConstantFactor * 23 * f(solutionSet[i][0], solutionSet[i][1])
		kappa2 = scalingConstantFactor * 16 * f(solutionSet[i-1][0], solutionSet[i-1][1])
		kappa3 = scalingConstantFactor * 5 * f(solutionSet[i-2][0], solutionSet[i-2][1])
...
func AdamsBashforth4(a float32, b float32, N int, initialCondition1 float32,
	...
	omega := omega4
	scalingConstantFactor := stepSize / 24
	...
	for i := 3; i < N; i++ {
		kappa = scalingConstantFactor * 55 * f(solutionSet[i][0], solutionSet[i][1])
		kappa2 = scalingConstantFactor * 59 * f(solutionSet[i-1][0], solutionSet[i-1][1])
		kappa3 = scalingConstantFactor * 37 * f(solutionSet[i-2][0], solutionSet[i-2][1])
		kappa4 = scalingConstantFactor * 9 * f(solutionSet[i-3][0], solutionSet[i-3][1])
...
func AdamsBashforth5(a float32, b float32, N int, initialCondition1 float32,
	...
	omega := omega5
	scalingConstantFactor := stepSize / 720
	...
	for i := 3; i < N; i++ {
		kappa = scalingConstantFactor * 1901 * f(solutionSet[i][0], solutionSet[i][1])
		kappa2 = scalingConstantFactor * 2774 * f(solutionSet[i-1][0], solutionSet[i-1][1])
		kappa3 = scalingConstantFactor * 2616 * f(solutionSet[i-2][0], solutionSet[i-2][1])
		kappa4 = scalingConstantFactor * 1274 * f(solutionSet[i-3][0], solutionSet[i-3][1])
		kappa5 = scalingConstantFactor * 251 * f(solutionSet[i-3][0], solutionSet[i-3][1])
